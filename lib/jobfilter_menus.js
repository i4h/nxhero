...
module.exports = {
    ...
    filterView: function(store, data, filters, options, callback) {
        module.exports.getFilteredViewData(store, data, filters, {}, function(err, data) {
            ...
            Menu.render(module.exports.menuActions, [], {data: data}, function(err, userInput) {
                ...
                switch(first) {
                    case 'f':
                        filters = module.exports.updateFilters(filters, userInput);
                        break;
                    case 'l':
     ...
     * @returns {*}
     */
    getFilteredViewData(store, data, filters, options, callback) {
        if (data !== null)
    ...
    getUniqueParamsAndValues(store, jobs, options, callback) {
    ...
    getJobsFiltered : function(store, filters, options, callback) {
        ...
        if (typeof filters.jobgroup !== "undefined") {
            if (typeof filters.jobgroup.ids !== "undefined") {
                Job = Job.where({jobgroup_id: filters.jobgroup.ids});
            }
