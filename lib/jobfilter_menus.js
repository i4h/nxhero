...
module.exports = {
        ...
        menu: {
            ...
            f: {
                ...
                menu: {
                    ...
                    t: JobFilter.getElementFilterMenu('Bianary(t)ype', 'Binary Type', function (input) {
                        return {
                            type: 'checkbox',
                            name: 'ids',
                            message: 'Binaries:',
            ...
            Menu.render(module.exports.menuActions, [], {data: data}, function(err, userInput) {
                ...
                switch(first) {
                    ...
                    case 'p':
                        ...
                        return module.exports.process(store, data, {}, userInput, callback);
                        break;
                    default:
    ...
    process : function(store, data, options, what, callback) {
        ...
        var processor = BaseProcessor.registry[processorId].processor;
        debug(processorId);
        debug(processor);
        ...
        inquirer.prompt({
            ...
            if (answers.confirm === true) {
                return module.exports.launchProcessor(store, data.jobs, processor, {}, callback);
            } else {
                debug("c");
                return callback(null);
            }
     ...
     * @param callback
     */
    launchProcessor: function(store, jobs, processor, options, callback) {
        return processor.process(store, jobs, {}, callback);
    },
